...
function Login() {
    ...
    useEffect(() => {
        document.body.style.backgroundImage = "linear-gradient(rgba(0, 0, 0, 0.65), rgba(0, 0, 0, 0.65)), url('/images/papernews.avif')"
        ...
        <>
            ...
            <div className="h-screen">
                ...
                <div className="flex justify-center items-center">
                    <div className="login">
                        <img className="flex justify-center w-64" src="/images/firma-rosa.avif" />
                        {forgot ?
                            <Form
                                layout="vertical"
                                form={form}
